...
import { setLoading, unsetLoading } from "redux/Slices/User/index";
import { getSpecificUser, getAllBookings, getSpecificWallet, getAllUsers } from "crud";
      ...
      <GridContainer>
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="warning" stats icon>
              ...
              <p className={classes.cardCategory}> All Agents </p>
              <h3 className={classes.cardTitle}>
                {" "}
                {listUsers
                  .filter(
                    (user) => user.systemRole !== "SUPER_ADMIN" && user.systemRole !== "OWNER"
                  )
                  .map((user) => (
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            ...
            <CardFooter stats>
              <div className={classes.stats}> All Time Sold Tickets </div>
            </CardFooter>
          </Card>
        </GridItem>
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="danger" stats icon>
              ...
              <p className={classes.cardCategory}> Sold Packages </p>
              <h3 className={classes.cardTitle}>
                {" "}
                {listBookings
            ...
            <CardFooter stats>
              <div className={classes.stats}> All TIme Sold Packages </div>
            </CardFooter>
          </Card>
        </GridItem>
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="info" stats icon>
              ...
              <p className={classes.cardCategory}> Sold Hotels </p>
              <h3 className={classes.cardTitle}>
                {" "}
                {listBookings
            ...
            <CardFooter stats>
              <div className={classes.stats}> All Time Sold Hotels </div>
            </CardFooter>
          </Card>
        </GridItem>
      </GridContainer>
        ...
        <GridItem xs={12} sm={12} md={6}>
          <Card>
            <CardHeader color="warning">
              ...
              <p className={classes.cardCategoryWhite}>New employees on 15 th September, 2016 </p>
            </CardHeader>
            <CardBody>
              <Table
